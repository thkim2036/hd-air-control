...
const { theme, skin, appRouteTransition, navbarType, footerType, isVerticalNavCollapsed, isVerticalNavSemiDark, appContentWidth, appContentLayoutNav, isAppRtl, isNavbarBlurEnabled, isLessThanOverlayNavBreakpoint, tagviewType, isBookmarkHidden } = useThemeConfig()
    ...
    >
      ...
      >
        ...
        <CustomizerSection title="LAYOUT">
          ...
          >
            <VRadio
              v-for="[key, val] in Object.entries(TagViewType)"
              :key="key"
              :label="key"
              :value="val"
            />
        ...
        <CustomizerSection title="MENU">
          ...
          <div class="mt-3 d-flex align-center justify-space-between">
            <VLabel
              for="customizer-menu-bookmark-hidden"
              class="text-high-emphasis"
            >
              Bookmark Hidden
            </VLabel>
            <div>
              <VSwitch
                id="customizer-menu-bookmark-hidden"
                v-model="isBookmarkHidden"
                class="ms-2"
              />
            </div>
          </div>
