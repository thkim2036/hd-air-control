...
export const useThemeConfig = () => {
  ...
  const isBookmarkHidden = computed({
    get() {
      return themeConfig.menu.isBookmarkHidden.value
    },
    set(value) {
      themeConfig.menu.isBookmarkHidden.value = value
      localStorage.setItem(`${themeConfig.app.title}-isBookmark`, value)
    },
  })
